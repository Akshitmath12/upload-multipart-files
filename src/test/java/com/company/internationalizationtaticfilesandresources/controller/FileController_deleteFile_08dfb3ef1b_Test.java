...
public class FileController_deleteFile_08dfb3ef1b_Test {
    ...
    public void testDeleteFileSuccess() {
        ...
        ResponseMessage responseMessage = new ResponseMessage(new StringBuilder("File deleted successfully"));
    ...
    public void testDeleteFileFailure() {
        ...
        ResponseMessage responseMessage = new ResponseMessage(new StringBuilder("File not found"));
